...
- **Article I — Technology stack**: Python 3.11+, pattern-driven orchestration (Windmill/LangGraph/CrewAI/AutoGen per Article I.B), Pydantic AI, PostgreSQL+pgvector with memory abstraction, MCP, Streamlit (Phase 1-2) / React/Next.js OR LibreChat (Phase 3+), DeepSeek 3.2 via Microsoft Azure AI Foundry (default)
- **Article II — Architectural principles (all 10)**:
